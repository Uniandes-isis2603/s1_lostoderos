...
public class HojaDeVidaLogic {
    ...
    public HojaDeVidaEntity create(HojaDeVidaEntity entity) throws BusinessLogicException {
        ...
        if (entity.getContratista() == null) {
            throw new BusinessLogicException("Debe especificar el contratista de la hoja de vida");
        }
    ...
    public HojaDeVidaEntity update(Long id, HojaDeVidaEntity entity) throws BusinessLogicException {
        ...
        if (newEntity == null) {
            throw new BusinessLogicException("No existe una hoja de vida con id: " + id);
        }
        if (entity.getContratista() == null) {
            throw new BusinessLogicException("Debe especificar el contratista de la hoja de vida");
        }
        ...
        contratista.setHojaVida(newEntity);
