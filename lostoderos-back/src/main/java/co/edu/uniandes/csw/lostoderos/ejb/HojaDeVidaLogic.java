...
public class HojaDeVidaLogic {
    ...
    */
    public HojaDeVidaEntity getHojaDeVidaContratista(Long contratistaId)throws BusinessLogicException{
        ...
        if(entity==null) throw new BusinessLogicException("El contratista consultado no tiene hoja de vida.");
    ...
    public HojaDeVidaEntity getHojaDeVida(Long id){
        ...
        if (hojaDeVida == null) LOGGER.log(Level.INFO,"La hoja de vida con el id no existe");
